			...
			<div className="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col pt-10 pb-20 md:px-6">
				<main className="flex flex-1 flex-col gap-6">
					<section className="max-w-2xl space-y-4">
						...
						{showManualGameInput ? (
							<form onSubmit={handleSubmit} className="flex items-baseline gap-3">
								<p className="text-sm">Enter the game id </p>
								<input
									type="text"
									value={gameId}
									...
									inputMode="numeric"
									pattern="[0-9]*"
									className="justify-items-start rounded-md border border-white/10 bg-white/5 px-2 py-1 text-center text-sm text-white transition outline-none focus:border-violet-400/70"
								/>
							</form>
						) : null}
					</section>
